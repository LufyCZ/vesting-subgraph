...
import {
  SushiMerkleDistributor,
  Claimed,
  MerkleRootUpdated,
  OwnershipTransferred
} from "../generated/SushiMerkleDistributor/SushiMerkleDistributor"
import { User, Claim, Week } from "../generated/schema"
import { BIG_DECIMAL_ZERO, BIG_DECIMAL_1E18, BIG_INT_ZERO, DISTRIBUTOR } from './constants';
...
export function getWeek(weekNumber: BigInt): Week {
    ...
    if (week === null) {
        let Distributor = SushiMerkleDistributor.bind(DISTRIBUTOR);
